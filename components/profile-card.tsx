                ...
                <div className="flex items-center">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <Star
                      key={i}
                      className={`w-4 h-4 ${
                        i < profile.rating ? 'fill-yellow-400 text-yellow-400' : 'text-gray-300'
                      }`}
                    />
                  ))}
          ...
          <div className="space-y-4">
            <div className="flex justify-between text-sm">
              ...
              <div>
                ...
                <div className="text-right text-purple-600 dark:text-purple-400 font-medium">
            ...
            <div className="grid grid-cols-3 gap-2 mt-4">
              {profile.images.map((image, index) => (
                ...
                >
                  <Image
                    src={image}
                    alt={`Trabajo de ${profile.name} ${index + 1}`}
                    fill
            ...
            <div className="flex gap-2 mt-6">
              <Button className="flex-1 dark:bg-purple-600 dark:text-white dark:hover:bg-purple-700" onClick={() => setIsVideoModalOpen(true)}>Contactar</Button>
